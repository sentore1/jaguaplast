...
export function GallerySection() {
  ...
  const images = [
    { src: "/shoes flyer/1.png", alt: "Product flyer 1" },
    { src: "/shoes flyer/2.png", alt: "Product flyer 2" },
    { src: "/shoes flyer/3.png", alt: "Product flyer 3" },
    { src: "/shoes flyer/4.png", alt: "Product flyer 4" },
    { src: "/shoes flyer/5.png", alt: "Product flyer 5" },
    { src: "/shoes flyer/6.png", alt: "Product flyer 6" },
  ];
