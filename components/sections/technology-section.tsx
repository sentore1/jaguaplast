...
export function TechnologySection() {
  ...
  const descriptionText = "At Jaguaplast, sustainability is engineered into every layer of production. We use recycled PVC and bio-based TPR compounds, run closed-loop moulding lines that eliminate landfill waste, and power our facilities with renewable energy. Every pair we manufacture is designed to last longer, tread lighter, and leave a smaller footprint on the planet.";
  ...
  const borderRadius = 0; // flat edges
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Built", "for the", "Planet."].map((word, index) => {
