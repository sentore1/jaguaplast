        ...
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative w-full">
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              ...
              >
                <Image
                  src="/shoes flyer/3.png"
                  alt="Jaguaplast luxury footwear collection"
                  fill
              ...
              >
                <Image
                  src="/shoes flyer/6.png"
                  alt="Jaguaplast comfort footwear craftsmanship"
                  fill
                  className="object-cover"
                />
              </div>
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            Jaguaplast delivers handcrafted luxury footwear engineered for the modern world. 
            Each pair marries refined aesthetics with advanced comfort technology built for those who never settle.
          </p>
        </div>
      </div>
    </section>
